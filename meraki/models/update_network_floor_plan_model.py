...
import meraki.models.center_1_model
...
class UpdateNetworkFloorPlanModel(object):
    ...
    def from_dictionary(cls,
        ...
        center = meraki.models.center_1_model.Center1Model.from_dictionary(dictionary.get('center')) if dictionary.get('center') else None
