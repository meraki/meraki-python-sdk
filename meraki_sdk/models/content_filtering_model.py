...
import meraki_sdk.models.allowed_url_patterns_model
import meraki_sdk.models.blocked_url_patterns_model
import meraki_sdk.models.blocked_url_categories_model
...
class ContentFilteringModel(object):
    ...
    def from_dictionary(cls,
        ...
        allowed_url_patterns = meraki_sdk.models.allowed_url_patterns_model.AllowedUrlPatternsModel.from_dictionary(dictionary.get('allowedUrlPatterns')) if dictionary.get('allowedUrlPatterns') else None
        blocked_url_patterns = meraki_sdk.models.blocked_url_patterns_model.BlockedUrlPatternsModel.from_dictionary(dictionary.get('blockedUrlPatterns')) if dictionary.get('blockedUrlPatterns') else None
        blocked_url_categories = meraki_sdk.models.blocked_url_categories_model.BlockedUrlCategoriesModel.from_dictionary(dictionary.get('blockedUrlCategories')) if dictionary.get('blockedUrlCategories') else None
