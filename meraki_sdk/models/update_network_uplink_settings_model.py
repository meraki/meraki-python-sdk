...
import meraki_sdk.models.bandwidth_limits_7_model
...
class UpdateNetworkUplinkSettingsModel(object):
    ...
    Attributes:
        bandwidth_limits (BandwidthLimits7Model): A mapping of uplinks to
    ...
    def from_dictionary(cls,
        ...
        bandwidth_limits = meraki_sdk.models.bandwidth_limits_7_model.BandwidthLimits7Model.from_dictionary(dictionary.get('bandwidthLimits')) if dictionary.get('bandwidthLimits') else None
