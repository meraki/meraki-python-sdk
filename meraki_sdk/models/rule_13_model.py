...
import meraki_sdk.models.definition_model
import meraki_sdk.models.per_client_bandwidth_limits_model

class Rule13Model(object):

    """Implementation of the 'Rule13' model.
    ...
    def __init__(self,
                 ...
                 dscp_tag_value=None,
                 priority=None):
        """Constructor for the Rule13Model class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('definitions') != None:
            ...
            for structure in dictionary.get('definitions'):
                definitions.append(meraki_sdk.models.definition_model.DefinitionModel.from_dictionary(structure))
        per_client_bandwidth_limits = meraki_sdk.models.per_client_bandwidth_limits_model.PerClientBandwidthLimitsModel.from_dictionary(dictionary.get('perClientBandwidthLimits')) if dictionary.get('perClientBandwidthLimits') else None
