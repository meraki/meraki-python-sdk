...
import meraki_sdk.models.rule_10_model
...
class UpdateNetworkSsidL3FirewallRulesModel(object):
    ...
    Attributes:
        rules (list of Rule10Model): An ordered array of the firewall rules
            for this SSID (not including the local LAN access rule or the
            default rule)
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('rules') != None:
            ...
            for structure in dictionary.get('rules'):
                rules.append(meraki_sdk.models.rule_10_model.Rule10Model.from_dictionary(structure))
