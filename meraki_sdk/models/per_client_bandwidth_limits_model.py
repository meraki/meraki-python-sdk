...
import meraki_sdk.models.bandwidth_limits_2_model
...
class PerClientBandwidthLimitsModel(object):
    ...
    Attributes:
        ...
        bandwidth_limits (BandwidthLimits2Model): The bandwidth limits object,
    ...
    def from_dictionary(cls,
        ...
        bandwidth_limits = meraki_sdk.models.bandwidth_limits_2_model.BandwidthLimits2Model.from_dictionary(dictionary.get('bandwidthLimits')) if dictionary.get('bandwidthLimits') else None
