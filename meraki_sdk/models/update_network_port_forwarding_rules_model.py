...
import meraki_sdk.models.rule_9_model
...
class UpdateNetworkPortForwardingRulesModel(object):
    ...
    Attributes:
        rules (list of Rule9Model): An array of port forwarding params
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('rules') != None:
            ...
            for structure in dictionary.get('rules'):
                rules.append(meraki_sdk.models.rule_9_model.Rule9Model.from_dictionary(structure))
