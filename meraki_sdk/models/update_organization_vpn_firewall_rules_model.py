...
import meraki_sdk.models.rule_14_model
...
class UpdateOrganizationVpnFirewallRulesModel(object):
    ...
    Attributes:
        rules (list of Rule14Model): An ordered array of the firewall rules
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('rules') != None:
            ...
            for structure in dictionary.get('rules'):
                rules.append(meraki_sdk.models.rule_14_model.Rule14Model.from_dictionary(structure))
