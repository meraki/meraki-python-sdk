...
import meraki_sdk.models.rule_6_model
...
class UpdateNetworkL7FirewallRulesModel(object):
    ...
    Attributes:
        rules (list of Rule6Model): An ordered array of the MX L7 firewall
            rules
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('rules') != None:
            ...
            for structure in dictionary.get('rules'):
                rules.append(meraki_sdk.models.rule_6_model.Rule6Model.from_dictionary(structure))
