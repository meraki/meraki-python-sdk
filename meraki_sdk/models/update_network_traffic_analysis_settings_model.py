...
import meraki_sdk.models.custom_pie_chart_item_model
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('customPieChartItems') != None:
            ...
            for structure in dictionary.get('customPieChartItems'):
                custom_pie_chart_items.append(meraki_sdk.models.custom_pie_chart_item_model.CustomPieChartItemModel.from_dictionary(structure))
