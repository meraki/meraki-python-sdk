...
import meraki_sdk.models.stp_bridge_priority_model
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('stpBridgePriority') != None:
            ...
            for structure in dictionary.get('stpBridgePriority'):
                stp_bridge_priority.append(meraki_sdk.models.stp_bridge_priority_model.StpBridgePriorityModel.from_dictionary(structure))
