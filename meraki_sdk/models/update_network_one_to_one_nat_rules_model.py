...
import meraki_sdk.models.rule_8_model
...
class UpdateNetworkOneToOneNatRulesModel(object):
    ...
    Attributes:
        rules (list of Rule8Model): An array of 1:1 nat rules
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('rules') != None:
            ...
            for structure in dictionary.get('rules'):
                rules.append(meraki_sdk.models.rule_8_model.Rule8Model.from_dictionary(structure))
