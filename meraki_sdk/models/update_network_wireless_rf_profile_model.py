...
import meraki_sdk.models.ap_band_settings_1_model
import meraki_sdk.models.two_four_ghz_settings_1_model
import meraki_sdk.models.five_ghz_settings_1_model
...
class UpdateNetworkWirelessRfProfileModel(object):
    ...
    def from_dictionary(cls,
        ...
        ap_band_settings = meraki_sdk.models.ap_band_settings_1_model.ApBandSettings1Model.from_dictionary(dictionary.get('apBandSettings')) if dictionary.get('apBandSettings') else None
        two_four_ghz_settings = meraki_sdk.models.two_four_ghz_settings_1_model.TwoFourGhzSettings1Model.from_dictionary(dictionary.get('twoFourGhzSettings')) if dictionary.get('twoFourGhzSettings') else None
        five_ghz_settings = meraki_sdk.models.five_ghz_settings_1_model.FiveGhzSettings1Model.from_dictionary(dictionary.get('fiveGhzSettings')) if dictionary.get('fiveGhzSettings') else None
