...
import meraki_sdk.models.center_model
...
class CreateNetworkFloorPlanModel(object):
    ...
    def from_dictionary(cls,
        ...
        center = meraki_sdk.models.center_model.CenterModel.from_dictionary(dictionary.get('center')) if dictionary.get('center') else None
