__all__ = [
    'update_device_camera_quality_and_retention_settings_model',
    'update_device_cellular_gateway_settings_model',
    'reserved_ip_range_model',
    'fixed_ip_assignment_model',
    'update_device_cellular_gateway_settings_port_forwarding_rules_model',
    'rule_model',
    ...
    'alert_model',
    'update_network_appliance_firewall_inbound_firewall_rules_model',
    'rule_1_model',
    'update_network_appliance_port_model',
    'bind_network_model',
    'update_network_bluetooth_settings_model',
    'create_network_camera_quality_retention_profile_model',
    'video_settings_model',
    'mv_21_mv_71_model',
    'mv_12_mv_22_mv_72_model',
    'mv_32_model',
    'mv_12_we_model',
    'update_network_camera_quality_retention_profile_model',
    'generate_network_camera_snapshot_model',
    'update_network_cellular_firewall_rules_model',
    'update_network_cellular_gateway_settings_connectivity_monitoring_destinations_model',
    'destination_model',
    'update_network_cellular_gateway_settings_dhcp_model',
    'update_network_cellular_gateway_settings_subnet_pool_model',
    'update_network_cellular_gateway_settings_uplink_model',
    ...
    'rule_12_model',
    'create_network_switch_link_aggregation_model',
    'switch_port_model',
    'switch_profile_port_model',
    'update_network_switch_link_aggregation_model',
    ...
    'override_model',
    'update_network_switch_settings_multicast_model',
    ...
    'create_organization_insight_monitored_media_server_model',
    'update_organization_insight_monitored_media_server_model',
