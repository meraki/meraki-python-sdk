...
import meraki_sdk.models.rule_3_model
...
class BonjourForwardingModel(object):
    ...
    Attributes:
        ...
        rules (list of Rule3Model): A list of the Bonjour forwarding rules for
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('rules') != None:
            ...
            for structure in dictionary.get('rules'):
                rules.append(meraki_sdk.models.rule_3_model.Rule3Model.from_dictionary(structure))
