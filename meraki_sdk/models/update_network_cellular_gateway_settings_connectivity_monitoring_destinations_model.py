...
class UpdateNetworkCellularGatewaySettingsConnectivityMonitoringDestinationsModel(object):

    """Implementation of the 'updateNetworkCellularGatewaySettingsConnectivityMonitoringDestinations' model.
    ...
    def __init__(self,
                 destinations=None):
        """Constructor for the UpdateNetworkCellularGatewaySettingsConnectivityMonitoringDestinationsModel class"""
