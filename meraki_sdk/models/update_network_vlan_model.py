...
import meraki_sdk.models.reserved_ip_range_1_model
import meraki_sdk.models.dhcp_option_model
...
class UpdateNetworkVlanModel(object):
    ...
    Attributes:
        ...
        reserved_ip_ranges (list of ReservedIpRange1Model): The DHCP reserved
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('reservedIpRanges') != None:
            ...
            for structure in dictionary.get('reservedIpRanges'):
                reserved_ip_ranges.append(meraki_sdk.models.reserved_ip_range_1_model.ReservedIpRange1Model.from_dictionary(structure))
        ...
        if dictionary.get('dhcpOptions') != None:
            ...
            for structure in dictionary.get('dhcpOptions'):
                dhcp_options.append(meraki_sdk.models.dhcp_option_model.DhcpOptionModel.from_dictionary(structure))
