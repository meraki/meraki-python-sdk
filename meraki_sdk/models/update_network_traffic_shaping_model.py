...
import meraki_sdk.models.rule_13_model
...
class UpdateNetworkTrafficShapingModel(object):
    ...
    Attributes:
        default_rules_enabled (bool): Whether default traffic shaping rules
            ...
            8.
        rules (list of Rule13Model): An array of traffic shaping rules. Rules
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('rules') != None:
            ...
            for structure in dictionary.get('rules'):
                rules.append(meraki_sdk.models.rule_13_model.Rule13Model.from_dictionary(structure))
