...
import meraki_sdk.models.traffic_shaping_rule_model
import meraki_sdk.models.l_3_firewall_rule_model
import meraki_sdk.models.l_7_firewall_rule_model
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('trafficShapingRules') != None:
            ...
            for structure in dictionary.get('trafficShapingRules'):
                traffic_shaping_rules.append(meraki_sdk.models.traffic_shaping_rule_model.TrafficShapingRuleModel.from_dictionary(structure))
        l_3_firewall_rules = None
        if dictionary.get('l3FirewallRules') != None:
            l_3_firewall_rules = list()
            for structure in dictionary.get('l3FirewallRules'):
                l_3_firewall_rules.append(meraki_sdk.models.l_3_firewall_rule_model.L3FirewallRuleModel.from_dictionary(structure))
        l_7_firewall_rules = None
        if dictionary.get('l7FirewallRules') != None:
            l_7_firewall_rules = list()
            for structure in dictionary.get('l7FirewallRules'):
                l_7_firewall_rules.append(meraki_sdk.models.l_7_firewall_rule_model.L7FirewallRuleModel.from_dictionary(structure))
