...
class UpdateNetworkApplianceFirewallInboundFirewallRulesModel(object):

    """Implementation of the 'updateNetworkApplianceFirewallInboundFirewallRules' model.
    ...
    def __init__(self,
        ...
        """Constructor for the UpdateNetworkApplianceFirewallInboundFirewallRulesModel class"""
