...
class MGDHCPSettingsController(BaseController):
    ...
    def get_network_cellular_gateway_settings_dhcp(self,
                                                   network_id):
        """Does a GET request to /networks/{networkId}/cellularGateway/settings/dhcp.
        ...
        # Prepare query URL
        _url_path = '/networks/{networkId}/cellularGateway/settings/dhcp'
    ...
    def update_network_cellular_gateway_settings_dhcp(self,
                                                      options=dict()):
        """Does a PUT request to /networks/{networkId}/cellularGateway/settings/dhcp.
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    network_id -- string -- TODO: type description here.
                        Example: 
                    update_network_cellular_gateway_settings_dhcp --
                        UpdateNetworkCellularGatewaySettingsDhcpModel -- TODO:
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('update_network_cellular_gateway_settings_dhcp')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
