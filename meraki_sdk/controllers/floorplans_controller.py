...
class FloorplansController(BaseController):
    ...
    def create_network_floor_plan(self,
        ...
        self.validate_parameters(network_id=options.get("network_id"),
                                 create_network_floor_plan=options.get("create_network_floor_plan"))
        ...
        # Prepare and execute request
        _request = self.http_client.post(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('create_network_floor_plan')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
    ...
    def get_network_floor_plan(self,
        ...
        Args:
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    network_id -- string -- TODO: type description here.
                        Example: 
                    floor_plan_id -- string -- TODO: type description here.
                        Example: 
        ...
        # Validate required parameters
        self.validate_parameters(network_id=options.get("network_id"),
                                 floor_plan_id=options.get("floor_plan_id"))

        # Prepare query URL
        _url_path = '/networks/{networkId}/floorPlans/{floorPlanId}'
        _url_path = APIHelper.append_url_with_template_parameters(_url_path, { 
            'networkId': options.get('network_id', None),
            'floorPlanId': options.get('floor_plan_id', None)
        })
        _query_builder = Configuration.base_uri
        _query_builder += _url_path
        _query_url = APIHelper.clean_url(_query_builder)
    ...
    def update_network_floor_plan(self,
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('update_network_floor_plan')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
