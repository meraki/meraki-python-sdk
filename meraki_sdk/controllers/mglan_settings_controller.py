...
class MGLANSettingsController(BaseController):
    ...
    def get_device_cellular_gateway_settings(self,
                                             serial):
        """Does a GET request to /devices/{serial}/cellularGateway/settings.
        ...
        # Prepare query URL
        _url_path = '/devices/{serial}/cellularGateway/settings'
    ...
    def update_device_cellular_gateway_settings(self,
                                                options=dict()):
        """Does a PUT request to /devices/{serial}/cellularGateway/settings.
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    serial -- string -- TODO: type description here. Example:
                        ...
                        UpdateDeviceCellularGatewaySettingsModel -- TODO: type
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('update_device_cellular_gateway_settings')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
