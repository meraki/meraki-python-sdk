...
class DevicesController(BaseController):
    ...
    def get_organization_devices(self,
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    ending_before -- string -- A token used by the server to
                        ...
                        applications. The link for the first, last, prev, or
                        next page in the HTTP Link header should define it.
                    configuration_updated_after -- string -- Filter results by
                        whether or not the device's configuration has been
        ...
        _query_parameters = {
            ...
            'configurationUpdatedAfter': options.get('configuration_updated_after', None)
        }
        _query_builder = APIHelper.append_url_with_query_parameters(_query_builder,
            _query_parameters, Configuration.array_serialization)
        _query_url = APIHelper.clean_url(_query_builder)
