...
class SwitchSettingsController(BaseController):
    ...
    def get_network_switch_settings_multicast(self,
                                              network_id):
        """Does a GET request to /networks/{networkId}/switch/settings/multicast.
        ...
        # Prepare query URL
        _url_path = '/networks/{networkId}/switch/settings/multicast'
        _url_path = APIHelper.append_url_with_template_parameters(_url_path, { 
            'networkId': network_id
        })
        _query_builder = Configuration.base_uri
    ...
    def update_network_switch_settings_multicast(self,
                                                 options=dict()):
        """Does a PUT request to /networks/{networkId}/switch/settings/multicast.
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    update_network_switch_settings_multicast --
                        UpdateNetworkSwitchSettingsMulticastModel -- TODO:
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('update_network_switch_settings_multicast')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
