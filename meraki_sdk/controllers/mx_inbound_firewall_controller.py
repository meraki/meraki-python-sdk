...
class MXInboundFirewallController(BaseController):
    ...
    def get_network_appliance_firewall_inbound_firewall_rules(self,
                                                              network_id):
        """Does a GET request to /networks/{networkId}/appliance/firewall/inboundFirewallRules.
        ...
        # Prepare query URL
        _url_path = '/networks/{networkId}/appliance/firewall/inboundFirewallRules'
    ...
    def update_network_appliance_firewall_inbound_firewall_rules(self,
                                                                 options=dict()):
        """Does a PUT request to /networks/{networkId}/appliance/firewall/inboundFirewallRules.
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('update_network_appliance_firewall_inbound_firewall_rules')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
